    ...
    <div class="container py-4 bg-light">
      <div class="continer py-4 bg-light">
        <h2 class="text-center fw-bold">
          One stop solution for all your LNG related projects.
        </h2>
        <p class="w-50 text-center mx-auto text-secondary">
          Excellence in all our endeavours, provide exceptional services...
        </p>
        <p class="w-50 text-center mx-auto text-secondary mb-0">
