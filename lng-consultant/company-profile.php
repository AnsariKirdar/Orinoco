      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 col-md-12 py-4">
          ...
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Project / piping layout for conversion of LNG vessel conversion to FSRU.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Draft layout for LNG terminal operational manual.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Ingeniously developing inhouse cargo simulator for LNG vessel.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span>Training modules for LNG/LPG carrier for a leading training center.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Nitrogen pipeline survey & certification for a major port in India.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Yard delivery of LNG vessel.
          </p>
          <p class="text-secondary">
            <span> <i class="fad fa-check"></i></span> Complete supervision of LNG vessel for dry-docking.
          </p>
        </div>
      </div>
