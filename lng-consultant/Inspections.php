...
<head>
  ...
  <title> Inspections: Pre-Vetting / Pre-Purchase / Technical</title>
</head>
    ...
    <div class="continer py-4">
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 py-4">
          <img src="img/slider/eba30c95582.jpg" class="w-100 rounded-20" alt="">
        </div>
        <div class="col-lg-6 col-md-12 py-4">
          <p class="text-secondary">Crystal Ocean was born to fervent endeavours conducted by individuals. These individuals have hands on experience as Mariners and Engineers. Expertise of these will oversee the training of newcomers. Candidates will be guided for LNG operations at sea.</p>
          <p class="small text-secondary">
            <b>Our experts are well-versed in</b>
            <br>
            <span>&nbsp;&nbsp;&nbsp; <i class="fad fa-check"></i></span> Text text Text text Text text Text text Text text Text
            <span>&nbsp;&nbsp;&nbsp; <i class="fad fa-check"></i></span> Text text Text text Text text Text text Text text Text
            <br>
            <span>&nbsp;&nbsp;&nbsp; <i class="fad fa-check"></i></span> Text text Text text Text text Text text Text text Text
            <br>
