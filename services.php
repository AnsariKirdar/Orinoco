...
<body>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 py-4">
          ...
          <p class="text-secondary">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Beatae minus illo saepe modi laudantium repudiandae.
          </p>
          ...
          <p class="text-secondary small">
            <button type="button" class="btn btn-primary px-4 mt-5">
              Learn More
            </button>
          </p>
        </div>
        ...
        <div class="col-lg-6 col-md-12 py-4">
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 p-3">
              <div class="bg-white rounded-20 p-2 py-3 shadow">
                <p class="px-3">
                  <span class="d-flex align-items-center justify-content-center bg-light shadow rounded-circle" style="width: 60px; height: 60px;">
                    <i class="fad fa-user-hard-hat text-primary h4"></i>
                  </span>
                </p>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 p-3">
              <div class="bg-white rounded-20 p-2 py-3 shadow">
                <p class="px-3">
                  <span class="d-flex align-items-center justify-content-center bg-light shadow rounded-circle" style="width: 60px; height: 60px;">
                    <i class="fad fa-drafting-compass text-primary h4"></i>
                  </span>
                </p>
                <p class="text-primary fw-bolder h5 px-3">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 p-3">
              <div class="bg-white rounded-20 p-2 py-3 shadow">
                <p class="px-3">
                  <span class="d-flex align-items-center justify-content-center bg-light shadow rounded-circle" style="width: 60px; height: 60px;">
                    <i class="fad fa-cogs text-primary h4"></i>
                  </span>
                </p>
                <p class="text-primary fw-bolder h5 px-3">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 col-sm-12 p-3">
              <div class="bg-white rounded-20 p-2 py-3 shadow">
                <p class="px-3">
                  <span class="d-flex align-items-center justify-content-center bg-light shadow rounded-circle" style="width: 60px; height: 60px;">
                    <i class="fad fa-people-carry text-primary h4"></i>
                  </span>
                </p>
                <p class="text-primary fw-bolder h5 px-3">
                  Supplies to Ship
  ...
  <div class="container py-5">
    <div class="row py-5">
      <div class="col-lg-2 col-md-1 col-sm-12"></div>
      <div class="col-lg-8 col-md-10 col-sm-12">
        <p class="text-center mb-0 h5 text-primary">Featured Service</p>
        <p class="text-center mb-0 h1 fw-bolder">Some More Services</p>
        <p class="text-center text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum quas minima necessitatibus nemo illum, dolores ratione vitae neque quos iusto! Dolorum totam illum incidunt ratione possimus repellendus cum aperiam, alias, voluptas repudiandae quae odit corrupti ullam. Eaque quasi nesciunt totam.</p>
      </div>
      <div class="col-lg-2 col-md-1 col-sm-12"></div>
    </div>
